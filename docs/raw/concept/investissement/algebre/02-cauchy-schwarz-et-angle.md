...
> 🔑 Le document [`modele.md`](../modele/modele.md) obtient $|\rho|\le 1$ à son étape 6 par un argument
...
> [cours sur la loi de Student](../statistique/loi-de-student/08-robustesse-et-limites.md).
