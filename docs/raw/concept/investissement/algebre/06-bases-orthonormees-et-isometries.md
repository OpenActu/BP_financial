...
> [cours sur la loi de Student](../statistique/loi-de-student/README.md).
...
> [module 11 du cours de statistique](../statistique/mathematique/11-invariance-par-rotation-et-lemme-de-projection.md). La réponse — les
> coordonnées restent i.i.d. $\mathcal N(0,1)$ — est le
> [théorème de Fisher–Cochran](../statistique/mathematique/16-theoreme-de-fisher-cochran.md).
...
[module 11 du cours de statistique](../statistique/mathematique/11-invariance-par-rotation-et-lemme-de-projection.md).
