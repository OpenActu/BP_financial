...
> différentiel de [`modele.md`](../modele/modele.md) (annuler deux dérivées partielles) retrouve cette
...
[`modele.md`](../modele/modele.md) pour la droite des moindres carrés.
