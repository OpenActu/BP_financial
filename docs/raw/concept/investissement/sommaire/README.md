...
Cinq cours autonomes, plus le document de référence [`modele.md`](../modele/modele.md). Ils
...
> document de référence dans [`modele/`](../modele/modele.md).
...
[`modele.md`](../modele/modele.md) normalise les moments par $n$ ; le cours de statistique utilise $n-1$ pour
