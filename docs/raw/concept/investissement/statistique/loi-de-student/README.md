...
Le document [`modele.md`](../../modele/modele.md) établit, de façon purement **déterministe**, les
...
|---|---|---|
| [**Algèbre linéaire euclidienne**](../../algebre/README.md) | 7 h 30 | Projection, orthogonalité, $\mathbb R^n=F\oplus F^\perp$, degrés de liberté comme **dimension** |
| [**Statistique mathématique**](../mathematique/README.md) | 32 h | Loi normale, vecteur gaussien, TCL, loi du $\chi^2$, **Fisher–Cochran**, intervalle de confiance |
...
- [**Module 15 — La loi du $\chi^2$**](../mathematique/15-loi-du-chi2.md) : la loi de $S^2$ ;
- [**Module 16 — Fisher–Cochran**](../mathematique/16-theoreme-de-fisher-cochran.md) ⭐ : le
  point de bascule — $\bar X\perp\!\!\!\perp S^2$, sans quoi la construction du module 4 est
  impossible ;
- [**Module 18 — L'intervalle de confiance**](../mathematique/18-intervalle-de-confiance.md) : la
...
| — | *Outils : [loi du $\chi^2$](../mathematique/15-loi-du-chi2.md) et [Fisher–Cochran](../mathematique/16-theoreme-de-fisher-cochran.md)* | *3 h 30* | *→ cours de statistique* |
...
> (Fisher–Cochran) ont été versés au [cours de statistique](../mathematique/README.md), dont ils
> sont les [modules 15](../mathematique/15-loi-du-chi2.md) et [16](../mathematique/16-theoreme-de-fisher-cochran.md). Les
...
> ⭐ Le module réellement pivot de l'édifice, [Fisher–Cochran](../mathematique/16-theoreme-de-fisher-cochran.md),
...
> [module 16 du cours de statistique](../mathematique/16-theoreme-de-fisher-cochran.md) explique précisément
