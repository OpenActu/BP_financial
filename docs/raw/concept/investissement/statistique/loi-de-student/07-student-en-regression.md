...
**Durée : 4 h.** C'est ici que le cours rejoint [`modele.md`](../../modele/modele.md). Ce module fournit
...
C'est la question à traiter en premier, et [Fisher–Cochran](../mathematique/16-theoreme-de-fisher-cochran.md)
y répond déjà.
...
Par le [lemme de projection](../mathematique/11-invariance-par-rotation-et-lemme-de-projection.md) (§ 11.3) :
...
$\sigma^2$, exactement comme au [§ 15.4 du cours de statistique](../mathematique/15-loi-du-chi2.md).
