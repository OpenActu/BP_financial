...
[Jensen probabiliste](../analyse/convexite/05-jensen-probabiliste.md).
...
croissance logarithmique**. Or $\log$ est **concave**, donc ([Jensen](../analyse/convexite/05-jensen-probabiliste.md)) :
...
> signe constant. Le [module 5 du cours de convexité](../analyse/convexite/05-jensen-probabiliste.md)
...
[module 6 de convexité](../analyse/convexite/06-minimisation-convexe.md).
...
([§ 18 du cours de statistique](../statistique/mathematique/18-intervalle-de-confiance.md)).
...
> ([§ 19](../statistique/mathematique/19-interpretation-de-la-confiance.md)).
