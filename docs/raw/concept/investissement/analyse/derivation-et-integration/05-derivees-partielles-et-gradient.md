...
**Ce qui est en jeu.** [`modele.md`](../../modele/modele.md) annule deux dérivées partielles pour obtenir les
...
de [`modele.md`](../../modele/modele.md), étape 1. *Vérifier que la première donne bien « les résidus sont
de moyenne nulle ».*
