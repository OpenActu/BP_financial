...
**Ce qui est en jeu.** [`modele.md`](../../modele/modele.md) dérive à la main une somme sur $n$ termes, deux
...
> par $n$, pas par $n-1$.** C'est exactement la convention de [`modele.md`](../../modele/modele.md), et cela
> **explique** l'écart de convention signalé dans le
> [README de statistique](../../statistique/mathematique/README.md) : $n$ vient du maximum de vraisemblance,
...
> 🔑 **Trois lignes remplacent les huit étapes de [`modele.md`](../../modele/modele.md)** — et pour un
...
deux équations partielles de [`modele.md`](../../modele/modele.md), étape 1.
...
[README de statistique](../../statistique/mathematique/README.md).*
...
$v_{0,\min}$ et $r_{\min}$ de [`modele.md`](../../modele/modele.md).
