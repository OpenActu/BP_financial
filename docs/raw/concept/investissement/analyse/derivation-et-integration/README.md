...
|---|---|---|
| [`modele.md`](../../modele/modele.md), étapes 1 et 3 | Dérivées partielles, équations normales | Calculées, non justifiées |
...
| [`modele.md`](../../modele/modele.md) | Les équations normales, obtenues en trois lignes au § 7.5 |
