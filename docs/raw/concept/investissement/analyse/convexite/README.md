...
|---|---|---|
| [`modele.md`](../../modele/modele.md), étape 1 | « quadratique de coefficient dominant $>0$, donc **strictement convexe** : son unique point critique est le minimum global » | Admis en une incise |
| [`modele.md`](../../modele/modele.md), étape 4 | La mise sous forme canonique, qui exhibe le minimum **sans dériver** | Admis |
| [Statistique § 2.5](../../statistique/mathematique/02-esperance.md) | L'**inégalité de Jensen**, $E(g(X))\ge g(E(X))$ | Énoncée, non démontrée |
| [Statistique § 15.4](../../statistique/mathematique/15-loi-du-chi2.md) | $E(S)<\sigma$ — le biais de l'écart type | Conséquence de Jensen, admise |
...
- un minimum local **est** global → module 6, et la preuve de [`modele.md`](../../modele/modele.md) devient
  une ligne ;
...
- **La probabilité** : elle est empruntée au [cours de statistique](../../statistique/mathematique/README.md) à
...
| [Statistique](../../statistique/mathematique/README.md) | L'espérance et ses règles (module 2), la variance (module 3), la loi normale (module 6f) |
| [Loi de Student](../../statistique/loi-de-student/README.md) | L'usage inférentiel de $S$, dont le module 5 explique le biais |
