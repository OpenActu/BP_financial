...
[`modele.md`](../../modele/modele.md) quand il écrit qu'une quadratique de coefficient dominant positif est
strictement convexe.
...
sans examen des bords. C'est ce que [`modele.md`](../../modele/modele.md) fait deux fois.
