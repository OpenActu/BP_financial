...
> [§ 9.3 du cours de dérivation et intégration](../../../semestre1/analyse/derivation-et-integration/09-changement-de-variable-et-densites.md).
> La constante $2^{k/2}\Gamma(k/2)$ est celle qui normalise l'intégrale à 1
> ([§ 4.4](../../../semestre1/analyse/derivation-et-integration/04-integrales-generalisees-et-moments.md)).
...
1. Le document [`modele.md`](../../../../modele.md) normalise par $n$ — c'est **légitime** dans son
...
2. $S^2$ est sans biais, mais **$S$ ne l'est pas** : $E(S)=c_4(n)\,\sigma<\sigma$, par concavité
   ...
   [§ 5.4 du cours d'analyse](../../../semestre1/analyse/convexite/05-jensen-probabiliste.md) : $-2{,}7\,\%$ à $n=10$,
   $-0{,}9\,\%$ à $n=30$). Il n'existe pas d'estimateur simple et sans biais de $\sigma$ — et
   c'est précisément le défaut que la
   [loi de Student](../../../semestre3/statistique/loi-de-student/README.md) est construite pour absorber.
