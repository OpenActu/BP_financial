...
> 📐 **Démontrée ailleurs.** Une ligne suffit — l'inégalité de la tangente appliquée en $E(X)$ — mais elle suppose la convexité définie : voir le [module 5 du cours d'analyse](../../../semestre1/analyse/convexite/05-jensen-probabiliste.md), qui en tire aussi le **drag de volatilité** et la valeur exacte du biais de $S$.
