...
notion de norme dans $\mathbb R^n$ (module 5 du [cours d'algèbre](../../../semestre1/algebre/01-produit-scalaire-et-norme.md)).
...
> [§ 9.4 du cours de dérivation et intégration](../../../semestre1/analyse/derivation-et-integration/09-changement-de-variable-et-densites.md),
