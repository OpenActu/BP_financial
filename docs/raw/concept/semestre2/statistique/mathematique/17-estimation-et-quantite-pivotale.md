...
[cours dédié](../../../semestre3/statistique/loi-de-student/README.md).
...
- **$\sigma$ connu est une fiction commode.** Le cas réel remplace $\sigma$ par $S$, et change la
  loi du pivot — c'est l'objet du [cours sur Student](../../../semestre3/statistique/loi-de-student/README.md).
