...
> 🔑 **On y reconnaît le Pythagore du [cours d'algèbre](../../../semestre1/algebre/README.md)**  ([§ 5.3](../../../semestre1/algebre/05-supplementaire-orthogonal-et-dimension.md)) : $\|x\|^2=\|\bar x\mathbf 1\|^2+\|\tilde x\|^2$. Même identité, écrite dans deux cadres — l'un descriptif, l'autre probabiliste.
...
- **$b$ disparaît.** Translater ne change pas la dispersion. C'est exactement l'invariance par
  translation de la covariance empirique du [§ 8.2 du cours d'algèbre](../../../semestre1/algebre/08-covariance-et-produit-scalaire.md) : les deux formes
