...
[cours de Student](../../../semestre3/statistique/loi-de-student/README.md).
...
> ce quelque chose porte un nom — la [loi de Student](../../../semestre3/statistique/loi-de-student/README.md).
...
| $\mathcal T(k)\to\mathcal N(0,1)$ | $k\to\infty$ | Pourquoi Student « redevient » normale | [Cours Student](../../../semestre3/statistique/loi-de-student/README.md), via (T3) |
