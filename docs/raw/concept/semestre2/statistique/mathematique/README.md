...
[cours d'algèbre linéaire](../../../semestre1/algebre/README.md) montre que ce sont des objets **géométriques**,
...
régression — fait l'objet d'un [cours dédié](../../../semestre3/statistique/loi-de-student/README.md), qui commence exactement
...
comme dimension) relève du [cours d'algèbre linéaire](../../../semestre1/algebre/README.md), qui est purement
déterministe.
...
[cours de dérivation et intégration](../../../semestre1/analyse/derivation-et-integration/README.md), qui les démontre tous
...
[cours d'analyse sur la convexité](../../../semestre1/analyse/convexite/README.md) : elle y est démontrée
([module 5](../../../semestre1/analyse/convexite/05-jensen-probabiliste.md)), ainsi que ses conséquences chiffrées — le
biais de $S$, le drag de volatilité, la prime de risque.

> 📐 **Le module 4 a un jumeau déterministe.** Le
> [module 8 du cours d'algèbre](../../../semestre1/algebre/08-covariance-et-produit-scalaire.md) traite la
