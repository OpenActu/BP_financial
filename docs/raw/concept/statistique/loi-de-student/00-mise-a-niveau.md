...
vous pouvez aborder le [théorème de Fisher–Cochran](../mathematique/16-theoreme-de-fisher-cochran.md) — le
...
> [cours d'algèbre linéaire euclidienne](../../algebre/README.md)** — cours séparé, 6 h 15 en sept
...
> du [cours de statistique](../mathematique/README.md)**,
...
|---|---|
| Produit scalaire | [1 — Produit scalaire, norme, distance](../../algebre/01-produit-scalaire-et-norme.md) |
| Sous-espace vectoriel, dimension | [5 — Supplémentaire orthogonal et dimension](../../algebre/05-supplementaire-orthogonal-et-dimension.md) |
| Projection orthogonale | [4 — La projection orthogonale](../../algebre/04-projection-orthogonale.md) |
| Supplémentaire orthogonal | [5 — Supplémentaire orthogonal et dimension](../../algebre/05-supplementaire-orthogonal-et-dimension.md) |
| Théorème de Pythagore | [3 — Orthogonalité et Pythagore](../../algebre/03-orthogonalite-et-pythagore.md) |
| Base orthonormée, isométrie | [6 — Bases orthonormées et isométries](../../algebre/06-bases-orthonormees-et-isometries.md) |
...
| **Q2** | Estimation, quantité pivotale, construction et **interprétation** d'un intervalle de confiance | ➡️ **[Cours de statistique, modules 17 à 19](../mathematique/17-estimation-et-quantite-pivotale.md)** — 3 h 45 |
| **Q3** | Convergence en loi, TCL, ses hypothèses et ses limites | ➡️ **[Cours de statistique, modules 12 à 14](../mathematique/12-theoreme-central-limite.md)** — 4 h 45 |
| **Q4** | Vecteur gaussien, stabilité par transformation linéaire, décorrélation vs indépendance | ➡️ **[Cours de statistique, modules 8 à 11](../mathematique/08-addition-de-lois-et-stabilite-gaussienne.md)** — 4 h 15 |
| **Exercice 0.2** | Produit scalaire, orthogonalité, projection, degrés de liberté comme **dimension** | ➡️ **[Cours d'algèbre linéaire](../../algebre/README.md)** — cours séparé, 6 h 15, **à traiter avant les modules 5 à 7 du [cours de statistique](../mathematique/README.md)** |
...
> Les [modules 17 à 19 du cours de statistique](../mathematique/17-estimation-et-quantite-pivotale.md) lui sont entièrement consacrés :
...
> ➡️ Les [modules 12 à 14 du cours de statistique](../mathematique/12-theoreme-central-limite.md) développent chacun de ces points, et répondent en
...
> Retenez cette structure : [Fisher–Cochran](../mathematique/16-theoreme-de-fisher-cochran.md) la reproduit
...
> ➡️ Les [modules 8 à 11 du cours de statistique](../mathematique/08-addition-de-lois-et-stabilite-gaussienne.md) développent entièrement cette question. Ils donnent le
...
> contente d'appliquer en dimension $n$. ⚠️ **Le [module 11](../mathematique/11-invariance-par-rotation-et-lemme-de-projection.md)
