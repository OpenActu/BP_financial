...
([encadrement 03](../encadrement/03-segmenter-un-historique-long.md)). Tolérance
...
Les quatre lectures du [§ 4.1 du cours encadrement](../encadrement/04-lire-l-encadrement.md#41--les-quatre-grandeurs) :
...
3. **Les erreurs ne sont pas i.i.d.** La volatilité est en grappes, et 2020 en est
   ...
   plus souvent que 5 % du temps ([canal 04](../canal/04-sorties-de-canal.md),
...
1. **Le titre a monté de 25 %.** Un `ACHAT` aurait « eu raison » en absolu. Cela
   ...
   [§ 9.10 de l'étape 9](../modele/09-exemple-complet.md) rappelle le cas
