...
[§ 4.1 du cours encadrement](../encadrement/04-lire-l-encadrement.md) : *la
...
séance ([canal 05](../canal/05-canal-glissant.md)) ; un critère non daté est
invérifiable.
...
|---|---|---|---|---|
| 1 | **Tendance longue** `TEND_120` | C | [modele 08](../modele/08-test-de-tendance.md) | oui, ternaire |
| 2 | **Tendance courte** `TEND_20` | C | idem | oui, ternaire |
| 3 | **Position dans l'encadrement actif** | I, J | [encadrement 04](../encadrement/04-lire-l-encadrement.md) | oui, $[0,1]$ |
...
|---|---|---|---|---|
| **Encadrement convexe** ([encadrement 01](../encadrement/01-la-droite-qui-ne-coupe-rien.md)) | 79,99 € | 93,18 € | 13,19 € — 16,0 % | **18,0 %** |
| Canal de régression ([canal 02](../canal/02-les-trois-largeurs.md)) | 66,23 € | 92,41 € | 26,18 € — 31,8 % | 61,6 % |
...
| F — sorties de canal | comptage utile en diagnostic, mais [6 sorties sur 10 sont du hasard](../canal/04-sorties-de-canal.md) sur 20 séances |
