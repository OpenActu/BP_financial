...
*(Le résultat vaut sous l'hypothèse d'erreurs i.i.d. de l'[étape 8](../modele/08-test-de-tendance.md).
...
> l'[étape 8](../modele/08-test-de-tendance.md), et elle joue ici dans les deux
