...
[`modele.md`](../../../modele.md), dont ce module est une **application directe**.
...
> 🔑 **C'est le trinôme de l'[étape 3 de `modele.md`](../../semestre3/modele/03-developpement-du-carre.md)**, à
> un changement de nom près : $V\to V$, $T\to M$, $r\to h$. La mise sous forme canonique de
> l'[étape 4](../../semestre3/modele/04-forme-canonique.md) donne immédiatement, **sans dériver** :
...
| $\rho^2$ ([étape 5](../../semestre3/modele/05-coefficient-de-correlation.md)) | **Efficacité de couverture** — la part de variance annulée |
| Résidus centrés ([étape 1](../../semestre3/modele/01-elimination-de-l-ordonnee.md)) | La couverture ne biaise pas la moyenne |
...
Le [module 7 du cours de Student](../../semestre3/statistique/loi-de-student/07-student-en-regression.md) donne
...
une fenêtre glissante, et se rappeler que l'[étape 8 de `modele.md`](../../semestre3/modele/08-test-de-tendance.md)
...
[forme canonique](../../semestre3/modele/04-forme-canonique.md) **sans dériver**, en recopiant l'étape 4 avec
les nouveaux noms.
...
- ⭐ **Le ratio de couverture de variance minimale est $h^\star=\operatorname{Cov}/\operatorname{Var}=\beta$**,
  ...
  [`modele.md`](../../../modele.md) mot pour mot ; il n'y a pas de second théorème.
