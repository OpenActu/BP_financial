...
| $w^{\top}\Sigma w$ convexe, $\Sigma$ matrice de Gram | [Convexité § 7](../../semestre1/analyse/convexite/07-convexite-en-dimension-n.md), [Algèbre § 8](../../semestre1/algebre/08-covariance-et-produit-scalaire.md) | **Module 8** : Markowitz est un problème convexe |
