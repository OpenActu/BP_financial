...
> 📐 **$w\mapsto w^{\top}\Sigma w$ est convexe** parce que $\Sigma$ est une **matrice de Gram** — celle des produits scalaires entre rendements centrés ([algèbre § 11](../../semestre1/algebre/11-covariance-et-produit-scalaire.md), [convexité § 7](../../semestre1/analyse/convexite/07-convexite-en-dimension-n.md)). Le problème est donc
