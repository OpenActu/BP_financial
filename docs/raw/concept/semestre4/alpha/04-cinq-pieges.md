...
[module 5 du cours convexité](../../semestre1/analyse/convexite/05-jensen-probabiliste.md) et
...
l'[étape 8](../../semestre3/modele/08-test-de-tendance.md) : $\varepsilon_t$ i.i.d. gaussiennes.
...
- **Les queues sont épaisses.** Les rendements ne sont pas gaussiens ; les
  ...
  ([statistique, § 13](../../semestre2/statistique/mathematique/13-portee-et-limites-du-tcl.md)).
...
sorties de canal du [module 4 du cours canal](../../semestre3/canal/04-sorties-de-canal.md),
