...
le [module 3 du cours canal](../../semestre3/canal/03-epaisseur-variable-et-levier.md) pour son
erreur type.
...
|---|---|---|
| 1 | [De quoi alpha est le nom](01-de-quoi-alpha-est-le-nom.md) | Le modèle de marché ; $\alpha$ est l'ordonnée à l'origine de l'[étape 1](../../semestre3/modele/01-elimination-de-l-ordonnee.md) ; l'alpha dépend du modèle qui le définit |
