...
**Prérequis :** [étape 1](../../semestre3/modele/01-elimination-de-l-ordonnee.md) et [étape 4](../../semestre3/modele/04-forme-canonique.md) du modèle.
...
L'[étape 1](../../semestre3/modele/01-elimination-de-l-ordonnee.md) établit
$v_{0,\min} = E(V) - r_{\min}E(T)$ : **c'est exactement la formule de l'alpha.**
L'[étape 4](../../semestre3/modele/04-forme-canonique.md) donne la pente, l'[étape 5](../../semestre3/modele/05-coefficient-de-correlation.md)
donne $R^2 = \rho^2$, l'[étape 8](../../semestre3/modele/08-test-de-tendance.md) donne la loi
...
$\phi(V)$, la droite symétrique de l'[étape 7](../../semestre3/modele/07-droite-ajustee.md) —
