...
**Prérequis :** [module 1](01-de-quoi-alpha-est-le-nom.md), et le [module 3 du cours canal](../../semestre3/canal/03-epaisseur-variable-et-levier.md) pour le levier.
...
([étape 1](../../semestre3/modele/01-elimination-de-l-ordonnee.md)), et estimateur sans biais
de la variance du bruit :

$$s^2 = \frac{1}{n-2}\sum_t \hat e_t^{\,2}$$

C'est le $s$ du [cours canal](../../semestre3/canal/README.md#notations), pas
$\sigma_{\hat e}$ : on divise par $n-2$, deux paramètres ayant été consommés.

## 2.3 — Les erreurs types viennent du levier

Le [module 3 du cours canal](../../semestre3/canal/03-epaisseur-variable-et-levier.md) définit
...
celle de l'[étape 8](../../semestre3/modele/08-test-de-tendance.md) :
...
|---|---|---|
| $R^2$ | $\rho^2$ ([étape 5](../../semestre3/modele/05-coefficient-de-correlation.md)) | part des mouvements expliquée par l'indice |
