...
> 📐 La projection orthogonale et l'identité de Pythagore qui sous-tendent cette décomposition sont traitées aux modules [3](../algebre/03-orthogonalite-et-pythagore.md) et [4](../algebre/04-projection-orthogonale.md) du cours d'algèbre.
