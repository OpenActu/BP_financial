# Module 2 — Produit scalaire, norme, distance

**Durée : 45 min.** Prérequis : [module 1](01-espace-vectoriel.md) — la structure de $\mathbb R^n$, sur laquelle ce module vient poser une géométrie. Aucun autre, au-delà des sommes indicées.
...
**Ce qui est en jeu.** Une seule opération, $\langle u,v\rangle=\sum_i u_iv_i$, suffit à produire tout le reste : norme, distance, orthogonalité, projection, degrés de liberté. Tous les modules suivants ne font que la développer.
...
> [module 5](05-orthogonalite-et-pythagore.md) est tout entier consacré au cas où il s'annule ;
> le [module 3](03-cauchy-schwarz-et-angle.md) au cas où il est maximal.

---

## 2.3 Norme et produit scalaire disent la même chose
...
Elle s'obtient en isolant le terme croisé dans l'identité de développement du § 2.2.
...
### S2.1 — Les trois propriétés, vérifiées numériquement
...
**E2.1.** Démontrer l'identité de polarisation du § 2.3 à partir de la seule identité de développement. *Quelle propriété du produit scalaire a-t-on utilisée pour égaler les deux termes croisés ?*

**E2.2.** Démontrer l'identité du parallélogramme $\|u+v\|^2+\|u-v\|^2=2\bigl(\|u\|^2+\|v\|^2\bigr)$. Puis l'appliquer à $u=(a,b)$, $v=(b,a)$ et interpréter. *(Piste : on retrouve $\operatorname{Var}$ et $\operatorname{Cov}$ de deux observations — voir le [module 10](10-dictionnaire-geometrique-des-statistiques.md).)*

**Preuve** : $\|u+v\|^2+\|u-v\|^2=2(\|u\|^2+\|v\|^2)$ par calcul direct ; $\|u\|^2=\langle u,u \rangle = a^2+b^2=\|v\|^2$
d'où $\|u+v\|^2+\|u-v\|^2=4(a^2+b^2)=4\|u\|$

**E2.3.** Montrer que $\|u\|=0\iff u=0$, et que $\|\lambda u\|=|\lambda|\,\|u\|$. *Laquelle des trois propriétés du § 2.1 chaque point utilise-t-il ?*
...
**E2.4.** Soit $\mathbf 1=(1,\dots,1)\in\mathbb R^n$. Calculer $\|\mathbf 1\|^2$ et $\langle x,\mathbf 1\rangle$ pour $x$ quelconque. *Ces deux quantités, d'apparence anodine, sont tout ce dont le [module 7](07-supplementaire-orthogonal-et-dimension.md) aura besoin.*
...
⬅️ [Module 1 — L'espace vectoriel $\mathbb R^n$](01-espace-vectoriel.md) ·
