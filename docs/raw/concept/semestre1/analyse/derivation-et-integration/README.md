...
| [Statistique § 9.4](../../../semestre2/statistique/mathematique/09-vecteur-gaussien.md) | « Une définition par la densité aurait exigé un calcul de **jacobien** » | Évité |
| [Statistique § 6d.4](../../../semestre2/statistique/mathematique/06d-loi-uniforme.md) | Transformation inverse et PIT | Admises |
| [Statistique § 15.3](../../../semestre2/statistique/mathematique/15-loi-du-chi2.md) | La densité du $\chi^2$ | Donnée |
...
- **Module 8 — Le facteur de volume.** Celui qui referme le cours : $\lvert\det J\rvert$ est le
  ...
  les densités du [cours de statistique](../../../semestre2/statistique/mathematique/README.md) — calculable.
...
- **Les équations différentielles**, sauf la seule qui sert au dépôt ($\varphi'=-t\varphi$, au
  [§ 7.3 de statistique](../../../semestre2/statistique/mathematique/07-loi-normale-et-ses-transformees.md)).
- **L'optimisation** : elle relève du [cours de convexité](../convexite/README.md), qui utilise les
  dérivées d'ici sans les redémontrer.
- **Les probabilités** : empruntées au [cours de statistique](../../../semestre2/statistique/mathematique/README.md) au
...
| [Statistique](../../../semestre2/statistique/mathematique/README.md) | Le calcul de densité par jacobien (§ 9.4, 15.3), l'intégrale de $E(g(X))$, $\Gamma$ |
