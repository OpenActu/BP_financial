...
[théorème central limite](../../../semestre2/statistique/mathematique/12-theoreme-central-limite.md). Ce n'est pas une
...
([§ 13.4 de statistique](../../../semestre2/statistique/mathematique/13-portee-et-limites-du-tcl.md)).
...
| Où | Formule | Lecture |
|---|---|---|
| [Densité du $\chi^2(k)$](../../../semestre2/statistique/mathematique/15-loi-du-chi2.md) | $f(x)=\frac{x^{k/2-1}e^{-x/2}}{2^{k/2}\Gamma(k/2)}$ | La constante **est** ce qui normalise $\int f=1$ |
...
> l'hypothèse dont dépend tout le [TCL](../../../semestre2/statistique/mathematique/12-theoreme-central-limite.md) — et sur
...
> ([§ 13.1 de statistique](../../../semestre2/statistique/mathematique/13-portee-et-limites-du-tcl.md)).
...
[§ 6b.6 de statistique](../../../semestre2/statistique/mathematique/06b-loi-binomiale.md) pour les coefficients binomiaux.
...
3. que conclure quant à l'hypothèse de variance finie du
   [module 12 de statistique](../../../semestre2/statistique/mathematique/12-theoreme-central-limite.md) ?
