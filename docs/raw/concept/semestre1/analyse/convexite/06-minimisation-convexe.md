...
**Ce qui est en jeu.** [`modele.md`](../../../../modele.md) écrit, à l'étape 1 : *« quadratique de
...
[`modele.md`](../../../../modele.md) prend soin de noter que l'infimum intérieur est **atteint**. La
...
- ⚠️ **La convexité ne donne pas l'existence** : il y faut compacité ou coercivité. Trois
  ...
  deux.
- La preuve de [`modele.md`](../../../../modele.md) est un problème convexe quadratique : la **forme
