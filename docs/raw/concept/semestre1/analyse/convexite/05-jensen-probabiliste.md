...
[modules 2 et 3 de statistique](../../../semestre2/statistique/mathematique/02-esperance.md) (espérance, variance).

> **La question traitée.** Le [cours de statistique](../../../semestre2/statistique/mathematique/02-esperance.md) énonce
...
L'espérance étant **croissante** ([§ 2.3 de statistique](../../../semestre2/statistique/mathematique/02-esperance.md)) et
**linéaire** :
...
|---|---|---|---|
| $x^2$ | Convexe | $E(X^2)\ge E(X)^2$ | $\operatorname{Var}(X)\ge0$ — [§ 3.1 stat](../../../semestre2/statistique/mathematique/03-variance-et-moments.md) |
| $1/x$ sur $\mathbb R_+^*$ | Convexe | $E(1/X)\ge1/E(X)$ | Le rendement moyen d'un panier $\ne$ l'inverse du prix moyen |
| $e^x$ | Convexe | $E(e^X)\ge e^{E(X)}$ | La **FGM** est $\ge$ $e^{\mu t}$ ([§ 5 stat](../../../semestre2/statistique/mathematique/05-fonction-generatrice-des-moments.md)) |
...
Le [cours de statistique](../../../semestre2/statistique/mathematique/02-esperance.md) affirme au § 2.5 que $S$ sous-estime
...
([module 14 de statistique](../../../semestre2/statistique/mathematique/14-dependance-et-echec-du-tcl.md)).
...
> [§ 11bis.5 du cours de statistique](../../../semestre2/statistique/mathematique/11bis-convergence-en-loi.md) montre que
...
*(Piste : $E(e^{-aW})$ est la FGM de la gaussienne, [§ 7.2 stat](../../../semestre2/statistique/mathematique/07-loi-normale-et-ses-transformees.md).)*
